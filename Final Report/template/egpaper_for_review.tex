...
either has been or will be submitted during the ICCV 2011 review period to
{\bf either a journal} or any conference (including ICCV 2011) or any
workshop (including ICCV 2011 workshops). 
Papers violating this condition will be rejected.
...
ICCV papers may be between 6 pages and 8 pages, with a \$100 per page added
...
\url{http://www.iccv.org/doc/mermin.pdf}.  
...
and you believe that the ICCV 11 audience would like to hear about your
...
chronological) order, so prefer \cite{Alpher03,Alpher02,Authors11} to
\cite{Alpher02,Alpher03,Authors11}.
...
Camera-ready final version only: AUTHOR NAME(s) and AFFILIATION(s) are to be centered beneath the title
...
example~\cite{Authors11}.  Where appropriate, include the name(s) of
